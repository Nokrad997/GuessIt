        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email = table.Column<string>(type: "varchar(50)", maxLength: 24, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -2, "user@user.com", "$2a$11$Q0F9Q4VWM5SntI2TVfDh1uXbabLKtIM8NNPYng9iI7l5o.LS0GFTG", "user", true });

            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "user_id", "email", "is_admin", "password", "username", "verified" },
                values: new object[] { -1, "admin@admin.com", true, "$2a$11$DsDGtCHkeJIgJ9onRDu44.7V5cYVmitn0BhuWnl.iQ2cQGCGCxH2e", "admin", true });
